...
{     
    ...
    public function get_access_login($user,$pass){
        $sql = $this->_db->prepare("SELECT
                                    ...
                                    adm_empleado.cargo, adm_empleado.email,adm_empleado.especialista, adm_empleado.telefono,
                                    adm_departamento.departamento,
                                    adm_persona.nombre,adm_persona.apellidos
                                    FROM adm_login
                                    INNER JOIN adm_empleado ON adm_empleado.id_usuario = adm_login.id_usuario
